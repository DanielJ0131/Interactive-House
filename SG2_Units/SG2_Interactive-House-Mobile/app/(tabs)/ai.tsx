...
// Allowed states for each device
...
// Type guard: checks if data is a valid AICommand
...
// Attempts to extract a valid AICommand from a string (handles raw JSON or embedded JSON)
...
// Executes a device control command by updating Firestore
...
/**
 * AI Screen component: chat interface for controlling smart house devices via AI.
 * Handles chat session, message history, device command execution, and guest mode.
 */
export default function AiScreen() {
  ...
  // Returns or creates a persistent chat session with the AI model
