...
jest.mock("@/app/context/SpeechContext", () => ({
  useSpeechContext: () => ({
    transcript: "",
    listening: false,
...
describe("HubPage", () => {
  ...
  test("emergency button opens emergency page from hub", async () => {
    const user = userEvent.setup();

    render(<HubPage />);

    await user.click(await screen.findByRole("button", { name: /Emergency/i }));
  ...
  test("changing orange light slider updates Firestore", async () => {
    render(<HubPage />);
